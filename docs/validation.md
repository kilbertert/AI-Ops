...
- `run-20260803T124243Z-65cd657e-5a88` 和临时 `elevated` 对照 run `run-20260803T124847Z-65cd657e-11d3` 均成功采集 order/fee evidence，但最终被本地 staged-artifact 读取失败阻断；没有业务写入。
- 修复待在本分支完成后重新分发并复跑；当前不能宣称 Windows 真实业务诊断已通过。
